...
namespace reco {
  ...
  GENERATE_SOA_LAYOUT(
      ...
      // local position error: xx, xy, yy, see DataFormats/GeometrySurface/interface/LocalError.h
      SOA_EIGEN_COLUMN(Vector3d, hit0LocalPosError),
      SOA_EIGEN_COLUMN(Vector3d, hit0GlobalPos),
      // global position error matrix: see DataFormats/GeometryCommonDetAlgo/interface/GlobalErrorBase.h
      SOA_EIGEN_COLUMN(Matrix4d, hit0GlobalPosError),
